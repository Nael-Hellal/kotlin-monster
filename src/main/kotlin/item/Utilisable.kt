 ...
 *
 * Les classes qui implémentent cette interface doivent fournir une implémentation de la méthode [utiliser].
 */
interface Utilisable {
     ...
     * @return `true` si l'action a eu un effet (ex: capture réussie, soin appliqué), `false` sinon.
     */
